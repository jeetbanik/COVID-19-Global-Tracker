...
data['Country'].iloc[184] = 'Central African Republic'
...
tfig = go.Figure(data=[go.Table(
    ...
    cells=dict(values=[dat['State/UT'], dat['Confirmed Cases'], dat['Recovered'], dat['Deaths'], dat['Active Cases'], dat['Death Rate']],
